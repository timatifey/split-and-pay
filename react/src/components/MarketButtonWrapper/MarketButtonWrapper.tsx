...
export const MarketButtonWrapper = ({className, icnSvgIcnIcnLg = "/img/icn-svg-icn-icn-lg.svg"}: {
    className: string,
    icnSvgIcnIcnLg: string
}) => {
    return (
        <div className={`market-button-wrapper ${className}`}>
            ...
            <div className="text-button-2">
                <div className="text-wrapper-2">Download on the</div>
